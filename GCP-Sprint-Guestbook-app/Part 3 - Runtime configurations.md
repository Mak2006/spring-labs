...
## Steps
4. Use Spring Cloud GCP to add support for Cloud Runtime Configuration API
5.  Create deployment profiles to selectively enable support for runtime configuration services
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyNTk3NTM0NiwtNzU5ODUyNDQ0LC0yMD
g4NzQ2NjEyXX0=
-->